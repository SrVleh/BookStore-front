...
const routes = [
    ...
    { path: Paths.NEW_BOOK, component: NewBook, meta: { requiresAuth: true, requiresAdmin: true } },
    { path: Paths.EDIT_BOOK, component: EditBook, props: true, meta: { requiresAuth: true, requiresAdmin: true }},
